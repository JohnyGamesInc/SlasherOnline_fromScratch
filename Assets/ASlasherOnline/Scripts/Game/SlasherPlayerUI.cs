...
namespace SlasherOnline
{
	...
	/// </summary>
	public class SlasherPlayerUI : MonoBehaviour
    {
		...
		public void SetTarget(SlasherPlayerManager _target){
			...
			if (playerNameText != null) {
                playerNameText.text = target.Id.ToString();
			}
		}
