...
namespace SlasherOnline
{
    ...
    public class SlasherPlayerManager : MonoBehaviourPunCallbacks, IPunObservable
    {
        ...
        public virtual void Start()
        {
            ...
            if (this.playerUiPrefab != null)
            {
                ...
                SlasherPlayerUI _uiGo = Instantiate(playerUiPrefab).GetComponent<SlasherPlayerUI>();
